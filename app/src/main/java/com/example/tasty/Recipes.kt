...
object STUB {
    ...
    private val burgerRecipes: List<Recipe> = listOf(
        Recipe(0,"Классический бургер с говядиной",
            listOf(
        ...
        Recipe(1, "Чизбургер с беконом",
            listOf(
                Ingredient("0.4","кг","говяжий фарш"),
                Ingredient("0.4","кг","ломтика сыра чеддер"),
                Ingredient("4.0", "шт", "булочки для бургера"),
                Ingredient("1.0", "шт", "помидор, нарезанный"),
                Ingredient("по вкусу", "", "майонез и кетчуп"),
            ), listOf("1. Обжарьте бекон на сковороде до хрустящей корочки, отложите на бумажное полотенце.",
